...
Une architecture à *N niveaux* ou *architecture N tiers* n'ajoute pas encore des niveaux supplémentaire à l'architecture à 3
niveaux mais introduit la notion des objets qui offre la possibilité de distribuer les services entre les 3 niveaux selon N
